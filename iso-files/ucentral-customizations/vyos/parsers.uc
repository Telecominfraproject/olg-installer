 ...
 *
 * Minimal parsing functions for VyOS commands that only return text output.
 * Most system data comes from the vyos-system-stats.py helper as JSON,
 * but DHCP leases, ARP tables, and NAT translations still require text parsing.
 *
